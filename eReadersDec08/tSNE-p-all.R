# Preprocessing of All Libraries for tSNE-p.
...
#
# The data is written to `data.dat` in the format specified and then the command 
# line tSNE tool must be called manually.

setwd("~/code/acrp/eReadersDec08")

config <- data.frame(
	datadir = "../vis/data/all-5-p",
	tSNE = "./tSNE_P",
	target_dims = 2,
	perplexity = 5,
	perc_landmarks = 1
